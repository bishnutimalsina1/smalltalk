...
import com.example.smalltalk16.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        auth = FirebaseAuth.getInstance(); //added to test

        //Account creation loading progress
        progressDialog = new ProgressDialog(SignInActivity.this);
        progressDialog.setTitle("Login");
        progressDialog.setMessage("You are being logged to your account");
        ...
        binding.clickSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SignInActivity.this, email_main.class);
                startActivity(intent);
            }
        });
        ...
        //This part has some issues, user should be logged in until token expires for some days
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //Store to Realtime database -> info for current logged in user from Google
